package MPP.Lesson9_part2.prob7;
...
public class Main {
	...
	public static void ordering1(List<Integer> list) {
		System.out.println(list.stream().sorted(Comparator.comparing(e -> Math.abs((Integer) e))
				.thenComparing(Comparator.comparing(e -> (Integer) e >= 0 ? 1 : 0))).collect(Collectors.toList()));
